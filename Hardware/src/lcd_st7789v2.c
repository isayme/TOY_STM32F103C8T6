...
// DC：指示 SPI 数据是 数据 or 控制
#define LCD_DC_Clr()   GPIO_ResetBits(GPIOA,GPIO_Pin_2)
#define LCD_DC_Set()   GPIO_SetBits(GPIOA,GPIO_Pin_2)

// CS：片选控制
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOA,GPIO_Pin_3)
#define LCD_CS_Set()   GPIO_SetBits(GPIOA,GPIO_Pin_3)

// BLK: 背光
#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOA,GPIO_Pin_4)
...
void LCD_ST7789V2_DrawPoint(int16_t x,int16_t y,uint16_t color) {
